...
//        String text = "https://blog.lifefun.in";
//        String text2 = "rwetetgdf345345";
//        String result;
//        String format = "png";
//        //生成二维码
//        File outputFile = new File("e:"+File.separator+"pdfhtml/1234.png");
...
//        //生成一维码
//        outputFile = new File("e:"+File.separator+"pdfhtml/123.png");
//        MatrixUtil.writeToFile(MatrixUtil.toBarCodeMatrix(text2, null, null), format, outputFile);
//
//        result = MatrixUtil.decode(outputFile);
//        System.out.println(result);
//    }
